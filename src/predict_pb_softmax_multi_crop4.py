...
tf.app.flags.DEFINE_string('crop4_image_dir', "/home/niusilong/projects/image-cut/src/main/webapp/images/crop4_120_3_128_temp", """四等分图片目录""")
...
tf.app.flags.DEFINE_string('graph_file', '/home/niusilong/work/AI/graph/competition-inception_v4_crop4_4740_40000.pb', """Where to save the trained graph.""")
...
tf.app.flags.DEFINE_integer('predict_label_count', 7, """最低预测分数""")
        ...
        for _ in range(FLAGS.output_file_count):   #导出文件的个数
            ...
            for step in range(total_steps):
                ...
                for i in range(len(final_tensor_val)):
                    ...
                    prediction_output_result = [str(label_index+1)+"("+str(softmax_val[i][label_index])+")" for label_index in sorted_array[:prediction_end_index]]
