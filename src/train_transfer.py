...
tf.app.flags.DEFINE_string('tfrecord_file_pattern', "/home/niusilong/work/AI/tfrecords/test_33_*.tfrecords", """包含图片，标签，multi-hot数据的压缩包""")
tf.app.flags.DEFINE_string('ckpt_save_dir', "/home/niusilong/work/AI/ckpt/competition-inception_v4_192_test", """保存训练后的模板数据目录""")
tf.app.flags.DEFINE_string('ckpt_save_file_name', "competition.ckpt", """模板文件名""")
tf.app.flags.DEFINE_string('output_graph', '/home/niusilong/work/AI/graph/multi-label-competition-inception_v4_192.pb', """Where to save the trained graph.""")
...
def main(argv=None):
    ...
    with slim.arg_scope(inception_v4.inception_v4_arg_scope()):
        logits, _ = inception_v4.inception_v4(images, num_classes=FLAGS.num_classes, dropout_keep_prob=0.8)
    #获取需要训练的变量
    ...
    with tf.Session() as sess:
        ...
        for i in range(FLAGS.train_steps):
            ...
            if (i+1) % 100 == 0 or (i+1) == FLAGS.train_steps:
                ...
                print("Step %d: Validation accuracy = %.2f%%" % (global_step.eval(), validation_accuracy*100.0))
        coord.request_stop()
        coord.join(threads)
