...
tf.app.flags.DEFINE_string('image_dir', "/home/niusilong/projects/image-cut/src/main/webapp/images/crop4_120_3_128", """""")
...
tf.app.flags.DEFINE_string('graph_file', '/home/niusilong/work/AI/graph/competition-inception_v4_crop4_4740_29000.pb', """Where to save the trained graph.""")
...
tf.app.flags.DEFINE_float('min_score', 0.0046, """最低预测分数, 平均数约为0.0038461538""")
tf.app.flags.DEFINE_integer('min_predict_count', 5, """最低预测分数""")
