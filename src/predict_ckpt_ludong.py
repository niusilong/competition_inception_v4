...
tf.app.flags.DEFINE_string('ckpt_save_file_path', "/home/niusilong/work/AI/ckpt/competition-inception_v4_4740_gt30_niusilong_bbox/competition.ckpt-24000", """模板文件名""")
...
def main(argv=None):
    ...
    with slim.arg_scope(inception_v4.inception_v4_arg_scope()):
        logits, _ = inception_v4.inception_v4(images, num_classes=FLAGS.num_classes, dropout_keep_prob=1.0, is_training=False)
    #获取需要训练的变量
