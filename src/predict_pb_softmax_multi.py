...
tf.app.flags.DEFINE_string('graph_file', '../pb/competition-inception_v4_4860_resetted_appointed_24000.pb', """Where to save the trained graph.""")
...
tf.app.flags.DEFINE_integer('min_predict_count', 3, """最低预测分数""")
tf.app.flags.DEFINE_integer('max_predict_count', 6, """最低预测分数""")
...
tf.app.flags.DEFINE_integer('output_file_count', 10, """导出文件个数""")
