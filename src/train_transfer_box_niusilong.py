...
tf.app.flags.DEFINE_string('tfrecord_file_pattern', "/home/niusilong/work/AI/tfrecords/competition_extended_192_*.tfrecords", """包含图片，标签，multi-hot数据的压缩包""")
tf.app.flags.DEFINE_string('ckpt_save_dir', "/home/niusilong/work/AI/ckpt/competition-inception_v4_extended", """保存训练后的模板数据目录""")
tf.app.flags.DEFINE_string('ckpt_save_file_name', "competition.ckpt", """模板文件名""")
tf.app.flags.DEFINE_string('output_graph', '/home/niusilong/work/AI/graph/competition_extended_192_.pb', """Where to save the trained graph.""")
