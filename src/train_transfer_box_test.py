...
#自定义参数，可以在sh脚本文件中修改
tf.app.flags.DEFINE_integer('train_steps', 2500, """""")
...
tf.app.flags.DEFINE_string('initial_ckpt_file', "/home/niusilong/work/AI/ckpt/competition-inception_v4_4740_gt30_niusilong_bbox/competition.ckpt-24000", """训练初始模板""")
# tf.app.flags.DEFINE_string('initial_ckpt_file', "/home/niusilong/work/AI/ckpt/inception_v4.ckpt", """训练初始模板""")
...
# tf.app.flags.DEFINE_string('ckpt_save_dir', "/home/niusilong/work/AI/ckpt/multi-label-competition-inception_v4", """保存训练后的模板数据目录""")
# tf.app.flags.DEFINE_string('ckpt_save_file_name', "multi-label-competition.ckpt", """模板文件名""")
# tf.app.flags.DEFINE_string('output_graph', '/home/niusilong/work/AI/graph/multi-label-competition-inception_v4.pb', """Where to save the trained graph.""")

# tf.app.flags.DEFINE_string('tfrecord_file_pattern', "/home/niusilong/work/AI/tfrecords/competition_4500_192_*.tfrecords", """包含图片，标签，multi-hot数据的压缩包""")
# tf.app.flags.DEFINE_string('tfrecord_file_pattern', "/home/niusilong/work/AI/tfrecords/competition_extended_192_4620_gt30_*.tfrecords", """包含图片，标签，multi-hot数据的压缩包""")

# tf.app.flags.DEFINE_string('tfrecord_file_pattern', "/home/niusilong/work/AI/tfrecords/competition_extended_192_4620_gt30_test2_additional_*.tfrecords", """包含图片，标签，multi-hot数据的压缩包""")
# tf.app.flags.DEFINE_string('ckpt_save_dir', "/home/niusilong/work/AI/ckpt/competition-inception_v4_4620_gt30", """保存训练后的模板数据目录""")
# tf.app.flags.DEFINE_string('ckpt_save_file_name', "competition_additional.ckpt", """模板文件名""")
# tf.app.flags.DEFINE_string('output_graph', '/home/niusilong/work/AI/graph/competition_extended_4620_gt30.pb', """Where to save the trained graph.""")
...
tf.app.flags.DEFINE_string('ckpt_save_dir', "/home/niusilong/work/AI/ckpt/competition_ludong", """保存训练后的模板数据目录""")
tf.app.flags.DEFINE_string('ckpt_save_file_name', "competition.ckpt", """模板文件名""")
tf.app.flags.DEFINE_string('output_graph', '/home/niusilong/work/AI/graph/competition-inception_v4_crop4_test.pb', """Where to save the trained graph.""")
...
def main(argv=None):
    ...
    with tf.Session() as sess:
        ...
        for i in range(FLAGS.train_steps):
            ...
            if (i+1) % 2 == 0 or (i+1) == FLAGS.train_steps:
